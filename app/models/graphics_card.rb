class GraphicsCard < ActiveRecord::Base
	...
	attr_accessible
	#Part_id, Price, Coreclock, Memoryclock, Memorysize, DirectX, Length, Minpower validations
	validates_numericality_of :part_id, :price, :coreclock, :memoryclock, :directx, :length,
	    :minpower, :memorysize, :greater_than => 0
	...
	validates_presence_of :hdmi, :dvi, :displayport, :vga, :svideo, :power6pin, :power8pin
